...
# so you can run the seed file multiple times without having duplicate entries in your database
    ...
    ra1 = ResearchAuthor(author = a1, research = r1)
    ra2 = ResearchAuthor(author = a2, research  = r2)
    ra3 = ResearchAuthor(author = a3, research = r3)
    ra4 = ResearchAuthor(author = a1, research = r3)
